...
public class SodiumGameOptionPages {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(AttackIndicator.class, vanillaOpts)
                        ...
                        .setControl(opts -> new CyclingControl<>(opts, AttackIndicator.class,
                                new ITextComponent[] {
                                        new TextComponentTranslation(AttackIndicator.OFF.getTranslationKey()),
                                        new TextComponentTranslation(AttackIndicator.CROSSHAIR.getTranslationKey()),
                                        new TextComponentTranslation(AttackIndicator.HOTBAR.getTranslationKey()) }))
                        .setBinding((opts, value) -> opts.attackIndicator = value.getId(),
                                (opts) -> AttackIndicator.byId(opts.attackIndicator))
                        .build())
                .build());
    ...
    public static OptionPage quality() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(SodiumGameOptions.GraphicsQuality.class, sodiumOpts)
                        ...
                        .setBinding((opts, value) -> opts.quality.cloudQuality = value,
                                opts -> opts.quality.cloudQuality)
                        .setImpact(OptionImpact.LOW)
                        .build())
                .add(OptionImpl.createBuilder(SodiumGameOptions.GraphicsQuality.class, sodiumOpts)
                ...
                .add(OptionImpl.createBuilder(int.class, sodiumOpts)
                        ...
                        .setBinding((opts, value) -> opts.quality.entityDistanceScaling = value / 100.0F,
        ...
        return new OptionPage(new TextComponentTranslation("sodium.options.pages.quality"),
    ...
    public static OptionPage advanced() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        ...
                        .setEnabled(MultidrawChunkRenderBackend
                                .isSupported(sodiumOpts.getData().advanced.ignoreDriverBlacklist))
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        ...
                        .setTooltip(
                                new TextComponentTranslation("sodium.options.animate_only_visible_textures.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.HIGH)
        ...
        return new OptionPage(new TextComponentTranslation("sodium.options.pages.advanced"),
                ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage performance() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, sodiumOpts)
                        ...
                        .setControl(o -> new SliderControl(o, 0, Runtime.getRuntime().availableProcessors(), 1,
                                ControlValueFormatter.quantityOrDisabled("sodium.options.threads.value",
                                        "sodium.options.default")))
                        .setImpact(OptionImpact.HIGH)
        ...
        return new OptionPage(new TextComponentTranslation("sodium.options.pages.performance"),
                ImmutableList.copyOf(groups));
    }
}

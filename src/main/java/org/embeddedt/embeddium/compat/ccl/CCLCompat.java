...
public class CCLCompat {
    ...
    private static final ThreadLocal<BufferBuilder> CCL_BUILDERS = CCL_LOADED ?
            ThreadLocal.withInitial(() -> new BufferBuilder(200 * 1024)) : null;
    ...
    static {
        try {
            CCL_RENDER = CCL_LOADED ? MethodHandles.publicLookup()
                    .unreflect(ObfuscationReflectionHelper.findMethod(BlockRenderingRegistry.class, "renderBlock",
                            void.class, IBlockAccess.class, BlockPos.class, IBlockState.class, BufferBuilder.class)) :
                    null;
        } catch (Throwable e) {
